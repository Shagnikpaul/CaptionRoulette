        ...
        <Link to={`/posts/${post.id}`} className="block group">
            <article className="relative rounded-2xl overflow-hidden border border-white/10 bg-black group">
                ...
                <div className="absolute top-3 left-3 right-3 flex items-start justify-between gap-2 pointer-events-none">
                    ...
                    <div className="flex items-center gap-1.5 rounded-full bg-black/25 backdrop-blur-md border border-yellow-500/25 px-2.5 py-1">
                        ...
                        <span className="text-[10px] font-semibold text-yellow-400">
                            Settled {formatSettlementDate(post.settledAt)}
                        </span>
                    </div>
                </div>
                ...
                <div className="absolute bottom-3 left-3 right-3 flex items-end justify-between gap-3 pointer-events-none">
                    ...
                    <div className="flex flex-col gap-0.5 rounded-xl bg-black/40 backdrop-blur-md border border-yellow-500/20 px-3 py-2 max-w-[70%]">
                        <div className="flex items-center gap-1 text-[9px] font-bold text-yellow-400 uppercase tracking-wider">
                            <Trophy className="size-2.5" />
                            Won by @{post.winningCaptionAuthor || "unknown"}
                        </div>
                        <p className="text-[11px] text-white/90 italic leading-snug line-clamp-2 mt-0.5">
